...
./qconcept -a $CONCEPT2 2 'устанавливать ?что обработчик (?чего событие, ?какой \"увеличивать (?что значение ?чего поле, ?на-сколько 1).\").'
./qconcept -a $CONCEPT2 3 'удалять ?что событие (?на-что изменение, ?для-чего поле).'
./qconcept -a $CONCEPT2 4 'устанавливать ?что значение (?чего поле, ?какой 1).'