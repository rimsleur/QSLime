...
./qconcept -a $CONCEPT2 2 'устанавливать ?что обработчик (?чего событие, ?какой \"выполнять ?что (=процедура ?что иметь ?что имя ?какой TestProcedure2).\").'
./qconcept -a $CONCEPT2 3 'регистрировать ?что событие (?на-что значение ?какой 10, ?для-чего поле).'
./qconcept -a $CONCEPT2 4 'устанавливать ?что обработчик (?чего событие, ?какой \"удалять ?что событие (?на-что изменение, ?для-чего поле).\").'
./qconcept -a $CONCEPT2 5 'устанавливать ?что значение (?чего поле, ?какой 1).'
./qconcept -c 5
CONCEPT1=`./qconcept -m`
./qsl2qsl -c "#$CONCEPT1 ?что быть ?чем процедура"
./qsl2qsl -c "#$CONCEPT1 ?что иметь ?что имя ?какой TestProcedure2"
./qconcept -c 7
CONCEPT2=`./qconcept -m`
./qsl2qsl -c "#$CONCEPT1 ?что быть ?чем #$CONCEPT2"
./qconcept -a $CONCEPT2 0 'печатать ?что значение ?чего поле.'
./qconcept -a $CONCEPT2 7 'увеличивать (?что значение ?чего поле, ?на-сколько 1).'